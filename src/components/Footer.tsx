// Footer Component
// Generated: 2025-08-29T11:13:37.526Z
...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: "Facebook", icon: Facebook, href: "https://facebook.com/techpulse" },
    { name: "Instagram", icon: Instagram, href: "https://instagram.com/techpulse" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Empowering developers and businesses with cutting-edge technology solutions. 
                Join thousands of innovators who trust TechPulse to accelerate their digital transformation.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@techpulse.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">+1 (555) 123-TECH</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">Silicon Valley, CA 94043</span>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 TechPulse. All rights reserved.</span>
