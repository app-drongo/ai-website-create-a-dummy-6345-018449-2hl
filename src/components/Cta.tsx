...
import { ArrowRight, Sparkles, Users, Zap, Shield, Cpu, Rocket, Clock } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "10K+", label: "Tech Companies", icon: Users },
    { value: "99.9%", label: "System Uptime", icon: Shield },
    { value: "500ms", label: "Response Time", icon: Zap },
    { value: "24/7", label: "Tech Support", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the next generation of tech innovators. Our cutting-edge platform empowers 
                startups and enterprises to build, deploy, and scale breakthrough solutions faster than ever.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                <Button size="lg" className="group text-base px-8 py-4">
                  ...
                  <Rocket className="ml-2 size-5 transition-transform group-hover:translate-x-1" />
                </Button>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Powering innovation at leading tech companies and startups
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Innovation Audit</h3>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Bank-grade encryption and compliance ready
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Go live in hours, not weeks with our tech stack
              </p>
            </div>
          </div>
        </div>
